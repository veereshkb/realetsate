...
<body>
  ...
  <p class="one">+91 81858 98089</p></a>
     ...
     <section class="pageheader overflow-hidden">
        <div class="container">
            <div class="pageheader__content">
                <h2>Our Project Grid</h2>
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        <li><a href="index.php">Home</a></li>
                        <li><a href="#0">pages</a></li>
                        <li class="active" aria-current="page">Project Grid</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <!-- Our Food gallery start here -->
	<div class="projectfilter projectfilter--bgnone overflow-hidden bg-white">
		<div class="container">   
			...
			<div class="section__wrapper">
                ...
                <div class="projectfilter__wrapper">
                    <div class="row g-4 projectfilter__filter">
                        <div class="col-md-6 col-lg-4 item1">
							<div class="projectfilter__item projectfilter__item--itemproject">
								<a href="#" class="go-top">
									<img src="https://arrjavafarms.com/images/gallery/gallery-7.jpg" alt="bakul">
								</a>
								<div class="inneritem go-up">
									<div class="upitem search">
										<a href="https://arrjavafarms.com/images/gallery/gallery-7.jpg" data-rel="lightcase:myCollections">
                        ...
                        <div class="col-md-6 col-lg-4 item2">
							<div class="projectfilter__item projectfilter__item--itemproject">
								<a href="#" class="go-top">
									<img src="https://arrjavafarms.com/images/gallery/gallery-2.jpg" alt="bakul">
								</a>
								<div class="inneritem go-up">
									<div class="upitem search">
										<a href="https://arrjavafarms.com/images/gallery/gallery-2.jpg" data-rel="lightcase:myCollections">
                                            <i class="fa-sharp fa-regular fa-eye"></i>
                                        </a>
									</div>
                        ...
                        <div class="col-md-6 col-lg-4 item3">
							<div class="projectfilter__item projectfilter__item--itemproject">
								<a href="#" class="go-top">
									<img src="https://arrjavafarms.com/images/gallery/gallery-6.jpg" alt="bakul">
								</a>
								<div class="inneritem go-up">
									<div class="upitem search">
										<a href="https://arrjavafarms.com/images/gallery/gallery-6.jpg" data-rel="lightcase:myCollections">
                                            <i class="fa-sharp fa-regular fa-eye"></i>
                                        </a>
									</div>
                        ...
                        <div class="col-md-6 col-lg-4 item4">
							<div class="projectfilter__item projectfilter__item--itemproject">
								<a href="#" class="go-top">
									<img src="https://arrjavafarms.com/images/gallery/gallery-4.jpg" alt="bakul">
								</a>
								<div class="inneritem go-up">
									<div class="upitem search">
										<a href="https://arrjavafarms.com/images/gallery/gallery-4.jpg" data-rel="lightcase:myCollections">
                                            <i class="fa-sharp fa-regular fa-eye"></i>
                                        </a>
									</div>
                        ...
                        <div class="col-md-6 col-lg-4 item3">
							<div class="projectfilter__item projectfilter__item--itemproject">
								<a href="#" class="go-top">
									<img src="https://arrjavafarms.com/images/gallery/gallery-5.jpg" alt="bakul">
								</a>
								<div class="inneritem go-up">
									<div class="upitem search">
										<a href="https://arrjavafarms.com/images/gallery/gallery-5.jpg" data-rel="lightcase:myCollections">
                                            <i class="fa-sharp fa-regular fa-eye"></i>  
                                       </a>
									</div>
                        ...
                        <div class="col-md-6 col-lg-4 item2">
							<div class="projectfilter__item projectfilter__item--itemproject">
								<a href="#" class="go-top">
									<img src="https://arrjavafarms.com/images/gallery/gallery-3.jpg" alt="bakul">
								</a>
								<div class="inneritem go-up">
									<div class="upitem search">
										<a href="https://arrjavafarms.com/images/gallery/gallery-3.jpg" data-rel="lightcase:myCollections">
                                            <i class="fa-sharp fa-regular fa-eye"></i>
                                        </a>
									</div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer__link">
                            ...
                            <ul>
                                ...
                                <li><i class="fa-solid fa-leaf"></i><a href="project.php">Project</a></li>
